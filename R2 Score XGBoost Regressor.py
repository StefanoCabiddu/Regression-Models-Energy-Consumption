...
model = xgb.XGBRegressor(device="cuda", booster="gblinear", nthread=32, 
                            colsample_bytree = 0.5, gamma = 0.5, learning_rate = 1, 
                            max_depth = 7, n_estimators = 200, subsample = 0.8)
