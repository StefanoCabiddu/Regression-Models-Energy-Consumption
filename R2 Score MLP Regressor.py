...
# Perform the grid search with R2 score as the evaluation metric
grid_search = GridSearchCV(mlp, param_grid, cv=5, scoring='r2')
...
plt.savefig('actual_vs_predicted_values_mlp_regressor.png')
plt.show()
...
plt.savefig('residuals_vs_predicted_values_mlp_regressor.png')
plt.show()
